...
def str_to_seconds(s):
    return int((Timestamp(s, tz='UTC') - EPOCH).total_seconds())


def seconds_to_timestamp(seconds):
    return Timestamp(seconds, unit='s', tz='UTC')
...
class BcolzDailyBarTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.writer = SyntheticDailyBarWriter(self.asset_info)
...
class USEquityPricingLoaderTestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.bcolz_writer = SyntheticDailyBarWriter(cls.asset_info)
